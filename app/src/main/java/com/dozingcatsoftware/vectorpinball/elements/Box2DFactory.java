...
public class Box2DFactory {
    ...
    /** Box2D's default fixture friction, used for walls unless overridden. */
    public static final float DEFAULT_WALL_FRICTION = 0.2f;
    ...
    public static Body createWall(
        ...
        return createWall(world, xmin, ymin, xmax, ymax, angle, 0f, DEFAULT_WALL_FRICTION);
    }
    ...
    public static Body createWall(
        ...
        return createWall(world, xmin, ymin, xmax, ymax, angle, restitution, DEFAULT_WALL_FRICTION);
    }
    ...
    public static Body createWall(
            World world, float xmin, float ymin, float xmax, float ymax,
            float angle, float restitution, float friction) {
    ...
    public static Body createThinWall(
        ...
        return createThinWall(world, x1, y1, x2, y2, restitution, DEFAULT_WALL_FRICTION);
    }

    /**
     * Creates a segment-like thin wall with 0.05 thickness going from (x1,y1) to (x2,y2), with
     * specified restitution and friction.
     */
    public static Body createThinWall(
            World world, float x1, float y1, float x2, float y2, float restitution, float friction) {
